...
def plus_button():
    ...
    input_1_p_sum =  input_1_p_sum +  input_1_p

    label_text = label_text + str(input_1_p)+"+"
    
    label_2 = tk.Label(root, text=str(label_text),anchor="w", font=("Arial", 20))
    label_2.place(x=50, y=525)

    print(input_1_p_sum)
    return input_1_p_sum
...
def clear_button():
    ...
    label_2 = tk.Label(root, text='',anchor="w", font=("Arial", 20))
    label_2.place(x=50, y=525)
...
# Label
label_1 = tk.Label(root, text="THE SIMPLE CALCULATOR", font=("Arial", 20))
label_1.pack(pady=10)

#label_2 = tk.Label(root, text="dw", font=("Arial", 20))
#label_2.place(x=50, y=525)
